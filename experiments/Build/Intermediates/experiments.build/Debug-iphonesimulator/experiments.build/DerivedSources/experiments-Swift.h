...
@property (nonatomic, strong) CLRegion * _Nullable lastRegion;
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified slackButton;
...
- (void)locationUpdate:(NSNotification * _Nonnull)notification;
- (IBAction)slack:(UIButton * _Nullable)sender message:(NSString * _Nonnull)message;
