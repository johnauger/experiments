...
@property (nonatomic, strong) CLRegion * __nullable lastRegion;
@property (nonatomic, readonly, strong) CLLocationManager * __nonnull locationManager;
@property (nonatomic, strong) CLBeaconRegion * __null_unspecified beaconRegion;
...
@property (nonatomic, weak) IBOutlet UIButton * __null_unspecified slackButton;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified label;
@property (nonatomic, weak) IBOutlet UILabel * __null_unspecified regionLabel;
@property (nonatomic, readonly, copy) NSDictionary<NSNumber *, UIColor *> * __nonnull colors;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (void)locationUpdate:(NSNotification * __nonnull)notification;
- (IBAction)slack:(UIButton * __nullable)sender message:(NSString * __nonnull)message;
